...
const connectionOptions = {
   ...
   browser: ['nekobot-md', 'Firefox', '3.0']
}
...
async function connectionUpdate(update) {
    ...
    // if (connection == 'open') console.log('- opened connection -')
        ...
        console.log(chalk.bold(chalk.rgb(233, 36, 116)('\n\n📍 Escanee el código QR que se enviará a continuación, el código QR caduca en 60 segundos')))
...
function getMessageConfig() {
    const welcome = '*Gracias @user por unirte al grupo @group.*'
